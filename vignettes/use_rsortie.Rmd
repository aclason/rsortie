...
* Individual tree means the model tracks individuals over time, trees are modelled individually, and each individual has a location and space  
* Spatially explicit means the model operates in real space, the location of an individual affects the processes (birth, growth, death), and it is resource-dependent  
